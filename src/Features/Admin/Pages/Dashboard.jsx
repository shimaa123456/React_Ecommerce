        ...
        <div className="container-fluid p-4">
          ...
          <div className="row">
            ...
            <div className="col-md-3">
              <div className="card text-center">
                <div className="card-body">
                  <i className="fas fa-users fa-2x text-info mb-3"></i> {/* Changed icon to users */}
                  <h5 className="card-title">3 Users</h5> {/* Display number of users */}
                  <p className="card-text">0 Active users</p> {/* Updated text */}
                </div>
              </div>
            </div>
